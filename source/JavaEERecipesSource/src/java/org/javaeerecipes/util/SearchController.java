...
package org.javaeerecipes.util;
...
import org.javaeerecipes.chapter06.AuthorController;
...
public class SearchController implements java.io.Serializable {
    ...
    public String searchAuthors(List authorList){
        ...
        List <org.javaeerecipes.chapter06.Author> tempList = authorList;
       
        for (org.javaeerecipes.chapter06.Author author: tempList){

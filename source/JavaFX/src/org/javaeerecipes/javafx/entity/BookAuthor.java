...
package org.javaeerecipes.javafx.entity;
...
@SqlResultSetMapping(name="authorBooks",
        entities= {
            @EntityResult(entityClass=org.javaeerecipes.javafx.entity.Book.class, fields={
                @FieldResult(name="id", column="BOOK_ID"),
                @FieldResult(name="title", column="TITLE")
            }),
            @EntityResult(entityClass=org.javaeerecipes.javafx.entity.BookAuthor.class, fields={
